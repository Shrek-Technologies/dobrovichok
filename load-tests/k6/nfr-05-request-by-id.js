...
export const options = {
  ...
  thresholds: {
    ...
    "http_req_duration{name:get_request}": ["p(95)<10000"],
  },
};
...
export default function () {
  ...
  const createBody = JSON.stringify({
    description: `nfr05 ${exec.vu.idInTest}-${exec.vu.iterationInScenario}`,
    contactPhone: "+79990001122",
    wardFirstName: "Контакт",
    wardLastName: "Тест",
    wardPatronymic: null,
  ...
  const got = http.get(`${baseUrl}/api/v1/requests/${requestId}`, {
